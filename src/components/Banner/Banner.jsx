        ...
        <div className="flex flex-col justify-center">
          <div className="space-y-4 text-center md:text-left lg:max-w-[450px]">
            <motion.h1
              ...
              initial="hidden"
              whileInView="show"
              className="text-3xl lg:text-4xl font-semibold font-poppins capitalize"
            >
            ...
            >
              <motion.button
                ...
                className="border-2 border-[#e33343] text-[#e33343] px-6 py-2 rounded-md hover:bg-[#e33343] hover:text-white duration-500"
              >
                Shop Now
              </motion.button>
            </UpdateFollower>
